...
if ( ! function_exists('edifice_get_not_selected_text') ) {
	/**
	 ...
	 */
	function edifice_get_not_selected_text( $label ) {
		return apply_filters( 'edifice_filter_not_selected_text',
								sprintf( apply_filters( 'edifice_filter_not_selected_mask', __( '- %s -', 'edifice' ) ), $label )
							);
	}
}

if ( ! function_exists( 'edifice_get_list_range' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'edifice_get_list_styles' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'edifice' ), $i );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'edifice' ),
			'no'  => esc_html__( 'No', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function edifice_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'edifice' ),
				0         => esc_html__( 'No', 'edifice' ),
			)
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'edifice_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'edifice' ),
			'off' => esc_html__( 'Off', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'edifice' ),
			'hide' => esc_html__( 'Hide', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'edifice' ),
			'hidden'  => esc_html__( 'Hidden', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_directions' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'edifice' ),
			'vertical'   => esc_html__( 'Vertical', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'edifice' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'edifice' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'edifice' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'edifice' ),
...
if ( ! function_exists( 'edifice_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'edifice' ),
				'icon'    => esc_html__( 'Icon', 'edifice' ),
				'icons'   => esc_html__( 'Icons', 'edifice' ),
				'zoom'    => esc_html__( 'Zoom', 'edifice' ),
				'fade'    => esc_html__( 'Fade', 'edifice' ),
				'slide'   => esc_html__( 'Slide', 'edifice' ),
				'pull'    => esc_html__( 'Pull', 'edifice' ),
				'border'  => esc_html__( 'Border', 'edifice' ),
				'excerpt' => esc_html__( 'Excerpt', 'edifice' ),
				'info'    => esc_html__( 'Info', 'edifice' ),
			)
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'edifice_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'edifice' ),
				'fullpost' => esc_html__( 'Full post', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'edifice' ),
...
if ( ! function_exists( 'edifice_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = edifice_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			edifice_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = edifice_array_merge( array( 'hide' => edifice_get_not_selected_text( esc_html__( 'Select widgets', 'edifice' ) ) ), $list );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'edifice' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'edifice' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'edifice' ),
...
if ( ! function_exists( 'edifice_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'edifice' ),
				'below' => esc_html__( 'Below the content', 'edifice' ),
				'float' => esc_html__( 'Floating bar', 'edifice' ),
			)
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'edifice_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'edifice_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'edifice_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'edifice_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_header_positions( $prepend_inherit = false ) {
		$list = array(
			'default' => esc_html__( 'Default', 'edifice' ),
			'over'    => esc_html__( 'Over', 'edifice' ),
			'under'   => esc_html__( 'Under', 'edifice' ),
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'edifice_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'edifice' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'edifice' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'edifice_filter_allow_fullscreen', $force_fullscreen || edifice_get_theme_setting( 'allow_fullscreen' ) || edifice_get_edited_post_type() == 'page' ) ) {
			$list['fullwide']   = array(
									'title' => esc_html__( 'Fullwidth', 'edifice' ),
									'icon'  => 'images/theme-options/body-style/fullwide.png',
									);
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'edifice' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'edifice_filter_list_body_styles', $list );
		return $prepend_inherit
					? edifice_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'edifice_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'edifice_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'edifice' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'edifice' ),
...
if ( ! function_exists( 'edifice_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'edifice' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'edifice' ),
...
if ( ! function_exists( 'edifice_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'edifice' ),
				'date'       => esc_html__( 'Published date', 'edifice' ),
				'modified'   => esc_html__( 'Modified date', 'edifice' ),
				'views'      => esc_html__( 'Views', 'edifice' ),
				'likes'      => esc_html__( 'Likes', 'edifice' ),
				'comments'   => esc_html__( 'Comments', 'edifice' ),
				'share'      => esc_html__( 'Share links', 'edifice' ),
				'categories' => esc_html__( 'Categories', 'edifice' ),
				'edit'       => esc_html__( 'Edit link', 'edifice' ),
			)
		);
...
if ( ! function_exists( 'edifice_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'edifice_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'edifice' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'edifice' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'edifice_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? edifice_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'edifice_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function edifice_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'edifice_filter_list_single_styles', edifice_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? edifice_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'edifice_get_list_categories' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_categories( $prepend_inherit = false ) {
		$list = edifice_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'edifice_filter_term_name', $cat->name, $cat );
				}
			}
			edifice_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_terms' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = edifice_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'edifice_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			edifice_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_posts_types( $prepend_inherit = false ) {
		$list = edifice_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'edifice_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'edifice' ),
				)
			);
			edifice_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_posts' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = edifice_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? edifice_get_not_selected_text( esc_html__( 'Not selected', 'edifice' ) ) : $opt['not_selected'];
			}
			$args = array(
...
if ( ! function_exists( 'edifice_get_list_users' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = edifice_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = edifice_get_not_selected_text( esc_html__( 'Not selected', 'edifice' ) );
			$users        = get_users(
				array(
			...
			edifice_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_menus' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_menus( $prepend_inherit = false ) {
		$list = edifice_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'edifice' );
			...
			edifice_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_icons' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'edifice_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			$lists = array();
			if ( 'icons' == $style ) {
				$lists[ $style ] = edifice_array_from_list( edifice_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = edifice_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = edifice_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'edifice_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'edifice_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function edifice_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : edifice_parse_icons_classes( edifice_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : edifice_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'edifice_get_list_images' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'edifice_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function edifice_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'edifice_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'edifice' ),
				'link2'   => esc_html__( 'Accent 2', 'edifice' ),
				'link3'   => esc_html__( 'Accent 3', 'edifice' ),
				'dark'    => esc_html__( 'Dark', 'edifice' ),
			)
		);
		return $prepend_inherit ? edifice_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'edifice' ) ), $list ) : $list;
	}
