...
if ( ! function_exists( 'edifice_tribe_events_get_css' ) ) {
	add_filter( 'edifice_filter_get_css', 'edifice_tribe_events_get_css', 10, 2 );
	function edifice_tribe_events_get_css( $css, $args ) {
