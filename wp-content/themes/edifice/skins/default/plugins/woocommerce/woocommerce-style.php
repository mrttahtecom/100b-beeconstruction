...
if ( ! function_exists( 'edifice_woocommerce_get_css' ) ) {
	add_filter( 'edifice_filter_get_css', 'edifice_woocommerce_get_css', 10, 2 );
	function edifice_woocommerce_get_css( $css, $args ) {
...
$fdir = edifice_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
