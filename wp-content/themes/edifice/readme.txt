...
Please install and activate it before starting to use the theme Edifice.
...
Theme documentation is available on https://doc.themerex.net/edifice/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Edifice is Fontello.
