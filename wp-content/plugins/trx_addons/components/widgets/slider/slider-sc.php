...
if ( !function_exists( 'trx_addons_sc_slider_controls' ) ) {
	function trx_addons_sc_slider_controls($atts, $content = ''){	
		...
		$arrow_prev = ! empty( $atts['icon'] ) ? trim( $atts['icon'] ) : 'slider_arrow_default';
						...
						.'">'
							. ( empty($atts['slider_id'])
								...
								: ( (empty($atts['hide_prev']) 
										? '<a class="slider_prev' . ( ! empty( $atts['title_prev'] ) ? ' with_title' : '' ) . ' ' . esc_attr( $arrow_prev ) . '" href="#">'
												. ( ! empty( $atts['title_prev'] ) ? esc_html( $atts['title_prev'] ) : '' )
											. '</a>' 
										: ''
										)
									. (empty($atts['hide_next']) 
										? '<a class="slider_next' . ( ! empty( $atts['title_next'] ) ? ' with_title' : '' ) . ' ' . esc_attr( $arrow_next ) . '" href="#">'
