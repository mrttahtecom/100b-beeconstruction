	...
	function trx_addons_cpt_layouts_get_list_options($add_parameters=array()) {
		return apply_filters('trx_addons_cpt_list_options', array_merge( array(
				...
				'layouts_create' => array(
					...
					"desc" => wp_kses_data( __('Press the button above to generate a set of layouts, created for this theme. These layouts have been automatically generated after theme activation. Use this button to re-generate deleted layouts. If a layout with the same name already exists, it will be skipped.', 'trx_addons') ),
