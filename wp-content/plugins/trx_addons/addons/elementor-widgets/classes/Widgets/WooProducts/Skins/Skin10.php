...
class Skin10 extends BaseSkin {
	...
	public function register_add_to_cart_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			'cta_view_products_label',
			array(
				'label'     => __( 'View Products Text', 'trx_addons' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'View Products', 'trx_addons' ),
			)
		);
		...
		$this->add_control(
			'cta_purchase_label',
			array(
				'label'     => __( 'Purchase Text', 'trx_addons' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'Purchase', 'trx_addons' ),
			)
		);

		$this->add_control(
			'cta_select_options_label',
			array(
				'label'     => __( 'Select Options Text', 'trx_addons' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => __( 'Select Options', 'trx_addons' ),
			)
		);
	...
	public function register_product_cta_style( Widget_Base $widget ) {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'cta_typography',
				'selector' => '{{WRAPPER}} .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn',
				'global'   => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'white',
				'selectors' => array(
					'{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', 'em', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn:hover' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'types'    => array( 'classic', 'gradient' ),
				'selector' => '{{WRAPPER}} .trx-addons-woo-products .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn:hover',
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn:hover',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
					'{{WRAPPER}} .trx-addons-woo-products-details-wrap .trx-addons-woo-products-atc-button .trx-addons-woo-products-cart-btn:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .trx-addons-woo-products-atc-button .trx-addons-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition' => array(
					$this->get_control_id( 'product_cta' ) => 'yes',
				),
	...
	public function register_quick_style_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'           => 'qv_background',
				'types'          => array( 'classic', 'gradient' ),
				'selector'       => '{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn',
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn:hover' => 'color: {{VALUE}}',
				),
			)
		);
	...
	public function render_quick_view() {
		...
		<div class="trx-addons-woo-products-qv-btn" data-product-id="<?php esc_attr_e( $product_id ); ?>">
			<?php $this->render_common_icon( 'qv_icon', array( 'default_icon' => 'far fa-eye', 'skin_used' => false ) ); ?>
		</div>
		<?php
	}
	...
	public function render_product_structure_cta() {
		...
		$label_view_products  = $this->get_instance_value( 'cta_view_products_label' );
		$label_purchase       = $this->get_instance_value( 'cta_purchase_label' );
		$label_select_options = $this->get_instance_value( 'cta_select_options_label' );
        ...
        if ( $product->is_in_stock() ) {
            switch ( $product_type ) {
                case 'simple':
                    $cta_string = ! empty( $label_buy_now ) ? $label_buy_now : __( 'Add To Cart', 'trx_addons' );
                    break;

                case 'grouped':
                    $cta_string = ! empty( $label_view_products ) ? $label_view_products : __( 'View Products', 'trx_addons' );
                    break;

                case 'external':
                    $cta_string = ! empty( $label_purchase ) ? $label_purchase : __( 'Purchase', 'trx_addons' );
                    break;

                case 'variable':
                case 'variation':
                    $cta_string = ! empty( $label_select_options ) ? $label_select_options : __( 'Select Options', 'trx_addons' );
                    break;
            }
        } else {
            $cta_string = ! empty( $label_select_options ) ? $label_select_options : __( 'Read More', 'trx_addons' );
        }

		do_action( 'trx_addons_woo_products_product_before_cta', $product_id, $settings );
        ?>
		<div class="trx-addons-woo-products-atc-button" <?php echo esc_attr( $attributes ); ?> >
			<a href="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="button trx-addons-woo-products-cart-btn <?php esc_attr_e( $cart_class ); ?> product_type_<?php esc_html_e( $product_type ); ?>" data-product_id="<?php esc_attr_e( $product_id ); ?>">
				<?php $this->render_common_icon( 'cta_icon', array( 'default_icon' => 'fas fa-plus' ) ); ?>
				<span class="trx-addons-woo-products-add-cart-icon-text"><?php esc_html_e( $cta_string ); ?></span>
			</a>
		</div>
		<?php
